// Selecionando os links de Excluir através da classe ".excluir" (colocada em cada link no HTML).
const links = document.querySelectorAll(".excluir");

// Percorrendo cada link selecionado anteriormente (conteúdo da constante "link")
for(const link of links){
    ...
    link.addEventListener("click", function(event){
        ...
        // Usando um confirm() para capturar a resposta do usuário, que pode ser OK/Sim (true) ou Cancelar/Não (false)
